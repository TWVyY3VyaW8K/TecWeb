...
<head>
    ...
    <meta name="title" content="Signup - Artbit"/>
...
<div class="fullScreenHeight loginTopPadding">
   ...
   <div id="LoginCard" class="loginCard container1024">
        <form class="loginCard-content " onsubmit="return validateSignUpForm()" method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
