...
\begin{document}
	...
	\chapter{Ambiguità incontrate e scelte intraprese}
		...
		\section{Utilizzo della lingua straniera}
				Il sito è stato scritto in inglese per garantire l'accessibilità al sito anche ad utenti che non conoscono la lingua italiana, in un mondo altamente globalizzato come il nostro è fondamentale che il sito sia interamente in lingua inglese essendo la lingua più conosciuta e la più comune sul web. Ovviamente ciascun utente potrà poi utilizzare liberamente qualsiasi lingua, incluse le lingue che utilizzano caratteri non latini, per interagire con il sito come inserire commenti e le descrizioni delle immagini.\\
	...
	\end{itemize}
	\subsection{Daniele Bianchin - Matricola xxxxxxx}
	\begin{itemize}
		\item Correzione della relazione
		\item SCRIVI COSA HAI FATTO PER QUANTO RIGUARDA LA SICUREZZA
