...
\begin{document}
	...
	%eventuali password degli utenti da utilizzare in fase di correzzione (una coppia login-password per ogni classe di utenza), in particolare:
		...
		\section{Test su diversi dispositivi}
			Il sito è stato testato su varie macchine e sistemi operativi. Nelle sezioni seguenti verranno elencati assieme ai browser e alle risoluzioni testate.
				...
				\begin{itemize}
					...
					\item Google Chrome 71
				\end{itemize}
				Durante la fase di test su questa piattaforma non sono emerse problematiche a livello di compatibilità o visibilità nonstante le alte risoluzioni.
	...
	\begin{itemize}
		\item Correzzione della relazione
		\item Correzzione bug di sicurezza
